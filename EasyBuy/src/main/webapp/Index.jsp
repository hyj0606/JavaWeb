...
<div class="top">
    ...
    <div class="i_car" setInterval="refreshTime(),1000;">
                                    ...
                                    <c:forEach var="p2" items="${p1.level}">
                                        <div class="zj_l_c">
                                            ...
                                            <c:forEach var="p3" items="${p2.level}">
                                                <a href="${pageContext.request.contextPath}/productServlet?id=${p3.id}">${p3.name} | </a><%--三级标题--%>
                                            </c:forEach>
                                        </div>
                                    </c:forEach>
                                </div>
...
<div class="i_bg bg_color">
    <div class="i_ban_bg">
        ...
        <div class="inews">
            ...
            <ul>
                <c:forEach var="anew" items="${newList}" >

                    <li><span>${anew.title}</span><a href="#">${anew.content}</a></li>
        ...
        $.ajax({
            ...
            success: function ( data ){
                ...
                for (var i = 0; i < data.length; i++) {
                    var opl = "<div class='img'><a href='#'><img src='images/car1.jpg' width='58' height='58' /></a>  </div>" +
                        "<div class='name'><a href='#'>"+data[i].product.name+"</a></div> "+
                        "<div class='price'><font color='#ff4e00'>￥"+data[i].product.price+"</font> X1</div>"
                    ops += opl;
                }
                $(".cars").html(ops);
            },
