    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="${pageContext.request.contextPath}/memberUserServlet?id=${user.id}" class="now">用户信息</a></li>
        ...
        <div class="m_right">
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%">登&nbsp; 录 &nbsp;名：<span style="color:#555555;">${user.loginName}</span></td>
                    <td width="60%">昵 &nbsp; &nbsp; 称：<span style="color:#555555;">${user.userName}</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <%--<td>性 &nbsp; &nbsp; 别：<span style="color:#555555;">${user.sex}</span></td>--%>
                </tr>
            </table>
