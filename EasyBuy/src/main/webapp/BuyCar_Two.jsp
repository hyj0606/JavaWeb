...
<body <%--onload="showAddress(${user.id});"--%>>
<!--Begin Header Begin-->
<div class="soubg">
    <div class="sou">
        <!--Begin 所在收货地区 Begin-->
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                        商品总价：￥${subtotal} ； 返还积分 56R
                    </td>
                </tr>
            </table>

            <div class="two_t">
                <span class="fr"><a href="${pageContext.request.contextPath}/">修改</a></span>收货人信息
            </div>
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                ...
                <form id="form1">
                    <c:forEach items="${addressList}" var="address">
                        <tr>
                            <td> <input type="radio" name="id" id="myRadio" onclick="getId();"  value="${address.id}" ></td>
                            <td ><input type="text" name="userName"  readonly="readonly" value="${address.user.userName}" /></td>
                            <td ><input type="text" name="email"  readonly="readonly" value="${address.user.email}" /></td>
                            <td ><input type="text" name="address"  readonly="readonly" value="${address.address}" /></td>
                            <td ><input type="text" name="tel"  readonly="readonly" value="${address.tel}" /></td>
                            <td ><input type="text" name="remark"  readonly="readonly" value="${address.remark}" /></td>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="right">
                        ...
                        商品总价: <font color="#ff4e00">￥ ${subtotal} </font>  + 配送费用: <font color="#ff4e00">￥15.00</font>
                    </td>
                </tr>
                <tr height="70">
                    <td align="right">
                        <b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">￥${subtotal+15}</span></b>
                    </td>
                </tr>
                <tr height="70" id="par">
                    <td align="right"><a href="${pageContext.request.contextPath}/buyCarThreeServlet"><img src="images/btn_sure.gif" /></a></td>
                </tr>
            </table>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function getId(){
        ...
        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/buyCarAddressServlet",
            data:str,
