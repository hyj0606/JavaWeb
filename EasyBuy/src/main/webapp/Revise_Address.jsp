...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right">
            ...
            <form action="${pageContext.request.contextPath}/reviseAddressServlet" method="post" >
                <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="right">收货人姓名</td>
                        <td style="font-family:'宋体';"><input type="text" name="userName" value="${address.user.userName}" class="add_ipt" />（必填）</td>
                        <td align="right">电子邮箱</td>
                        <td style="font-family:'宋体';"><input type="text" name="email" value="${address.user.email}" class="add_ipt" />（必填）</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="font-family:'宋体';"><input type="text" name="mobile" value="${address.user.mobile}" class="add_ipt" />（必填）</td>
                        <td align="right">收货人手机</td>
                        <td style="font-family:'宋体';"><input type="text" name="tel" value="${address.tel}" class="add_ipt" /></td>
                    </tr>
                    <tr>
                        <td align="right">备注</td>
                        <td style="font-family:'宋体';"><input type="text" name="remark" value="${address.remark}" class="add_ipt" /></td>
