    ...
    <div class="content">
        ...
        <div class="pro_des">
            ...
            <div class="des_join">
                ...
                <%--<input type="button" onclick="history.go(-1)" value="退出"/>--%>
                <span class="fl"><a onclick="addBuyCar(${product.id});"><img src="images/j_car.png" /></a></span>
    ...
    function addBuyCar(id1){
        $.ajax({
            ...
            success: function ( r ){
                ...
                /*location.href="${pageContext.request.contextPath}/productDetailsServlet"*/
            },
            error: function (){
